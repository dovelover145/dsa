...
int main() {
    ...
    get_matrix_dimensions_from_user(
        "Enter the dimensions of matrix A: ", &num_rows_a, &num_cols_a);
    matrix_a = make_empty_matrix(num_rows_a, num_cols_a);
    printf("Enter Matrix A\n");
    fill_matrix_from_user_input(matrix_a, num_rows_a, num_cols_a);

    get_matrix_dimensions_from_user(
        "Enter the dimensions of matrix B: ", &num_rows_b, &num_cols_b);
    matrix_b = make_empty_matrix(num_rows_b, num_cols_b);
    printf("Enter Matrix B\n");
    fill_matrix_from_user_input(matrix_b, num_rows_b, num_cols_b);

    matrix_c =
        matrix_multiply(matrix_a, num_rows_a, num_cols_a, matrix_b, num_rows_b,
                        num_cols_b, &num_rows_c, &num_cols_c);
