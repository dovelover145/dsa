...
int main() {
    ...
    // Testing isEmpty() on an empty dictionary
    cout << "The dictionary should be empty (1): " << h.isEmpty() << endl << endl;
    
    cout << "Adding items to the dictionary and printing..." << endl;
    ...
    // Testing add(const KeyType& searchKey, const ItemType& newItem) and display()
    h.display();
    cout << endl;
    
    // Testing getNumberOfItems()
    cout << "Number of items in the dictionary: " << h.getNumberOfItems() << endl << endl;
    
    // Testing remove(const KeyType& searchKey) and getNumberOfItems()
    h.remove("dylan");
    h.remove("einstein");
    h.remove("richardson");
    cout << "After removing, the dictionary should have two less items: " << h.getNumberOfItems() << endl << endl;
    
    // Testing isEmpty() on a non-emtpy dictionary
    cout << "The dictionary shouldn't be empty (0): " << h.isEmpty() << endl << endl;
    
    // Testing contains(const KeyType& searchKey)
    cout << "The dictionary should contain motzart (1): " << h.contains("motzart") << endl;
    cout << "The dictionary should contain gandhi (1): " << h.contains("gandhi") << endl;
    cout << "The dictionary shouldn't contain richardson (0): " << h.contains("richardson") << endl << endl;
    
    // Testing getItem(const KeyType& searchKey)
    try {
        cout << "The dictionary should contain motzart: " << h.getItem("motzart") << endl;
        cout << "The dictionary should contain gandhi: " << h.getItem("gandhi") << endl;
        cout << "The dictionary shouldn't contain richardson: " << h.getItem("richardson") << endl;
    } catch (HashedDictionary<string, FamousPerson>::NotFoundException notFound) {
        cout << "richardson wasn't found, and a notFoundException was caught." << endl << endl;
    }
    
    // Testing clear(), display(), and isEmpty()
    h.clear();
    cout << "After clearing the dictionary, there shouldn't be anything displayed: " << endl;
    h.display();
    cout << "The dictionary should be empty (1): " << h.isEmpty() << endl << endl;
...
/*
 ...
 The dictionary should be empty (1): 1

 Adding items to the dictionary and printing...
 ...
 Number of items in the dictionary: 1049

 After removing, the dictionary should have two less items: 1047

 The dictionary shouldn't be empty (0): 0

 The dictionary should contain motzart (1): 1
 The dictionary should contain gandhi (1): 1
 The dictionary shouldn't contain richardson (0): 0

 The dictionary should contain motzart: 01 m motzart amadeous 25 2nd 94233
 The dictionary should contain gandhi: 37 m gandhi mohatmas 53 5th 95123
 The dictionary shouldn't contain richardson: richardson wasn't found, and a notFoundException was caught.

 After clearing the dictionary, there shouldn't be anything displayed:
 The dictionary should be empty (1): 1
