...
class LL {
   ...
   public:
    class iterator {
       public:
        iterator(node* initial = nullptr) { current = initial; }
        ...
        const node* link() const { return current; }

        node*& link() { return current; }
    ...
    class const_iterator {
       public:
        const_iterator(const node* initial = nullptr) { current = initial; }
