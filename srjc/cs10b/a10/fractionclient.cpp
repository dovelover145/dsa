...
void BasicTest() {
    ...
    const Fraction fr[] = {Fraction(4, 8),   Fraction(-15, 21), Fraction(10),
                           Fraction(12, -3), Fraction(),        Fraction(28, 6),
                           Fraction(0, 12)};
...
void RelationTest() {
    ...
    for (int i = 0; i < 5; i++) {
        ...
        cout << "\tIs left <= right? " << boolString(fr[i] <= fr[i + 1])
             << endl;
        cout << "\tIs left > right? " << boolString(fr[i] > fr[i + 1]) << endl;
        cout << "\tIs left >= right? " << boolString(fr[i] >= fr[i + 1])
             << endl;
        cout << "\tDoes left == right? " << boolString(fr[i] == fr[i + 1])
             << endl;
        cout << "\tDoes left != right ? " << boolString(fr[i] != fr[i + 1])
             << endl;
    }
...
void BinaryMathTest() {
    ...
    const Fraction fr[] = {Fraction(1, 6), Fraction(1, 3), Fraction(-2, 3),
                           Fraction(5), Fraction(-4, 3)};
...
void MathAssignTest() {
    ...
    Fraction fr[] = {Fraction(1, 6), Fraction(4), Fraction(-1, 2), Fraction(5)};
